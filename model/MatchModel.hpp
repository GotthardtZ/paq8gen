#ifndef PAQ8GEN_MATCHMODEL_HPP
#define PAQ8GEN_MATCHMODEL_HPP
...
private:
    ...
    enum Parameters : uint32_t {
        ...
        MinLen = 16, /**< minimum required match length */
        StepSize = 8, /**< additional minimum length increase per higher order hash */
    };
